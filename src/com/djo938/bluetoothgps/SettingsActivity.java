...
public class SettingsActivity extends PreferenceActivity 
{
	...
	private void setupSimplePreferencesScreen() {
		...
		fakeHeader = new PreferenceCategory(this);
		fakeHeader.setTitle(R.string.pref_header_tcpip);
		getPreferenceScreen().addPreference(fakeHeader);
		addPreferencesFromResource(R.xml.pref_tcpip);
		...
		bindPreferenceSummaryToValue(findPreference("tcpip_port"));
		bindPreferenceSummaryToValue(findPreference("tcpip_max"));
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public static class BluetoothPreferenceFragment extends
			PreferenceFragment {
		@Override
		public void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
	 ...
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public static class TcpipPreferenceFragment extends PreferenceFragment {
		@Override
		public void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.pref_tcpip);
